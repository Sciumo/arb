...
CONSTEXPR_INLINE bool isMackeHeader(const char *line)    { return line[0] == '#'; }
CONSTEXPR_INLINE bool isMackeSeqHeader(const char *line) { return line[0] == '#' && line[1] == '='; }
CONSTEXPR_INLINE bool isMackeSeqInfo(const char *line)   { return line[0] == '#' && line[1] == ':'; }

CONSTEXPR_INLINE bool isMackeNonSeq(const char *line)    { return line[0] == '#' || line[0] == '\n' || line[0] == ' '; }
